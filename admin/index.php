...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title> Leave Application System |  Admin</title>
...
<nav class="navbar navbar-expand-lg navbar-light py-3">
          ...
          <div class="navbar-nav d-flex justify-content-center align-items-center">
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="#">Faculty Login</a>
        ...
        <h4 class="font-weight-bold text-center text-danger">Welcome to Leave Application System</h4>
